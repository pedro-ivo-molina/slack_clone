defmodule SlackCloneWeb.Live.Components.Sidebar do
  ...
  def update(%{current_user: current_user, current_room_id: current_room_id} = _assigns, socket) do
    {:ok, assign(socket, current_user: current_user, current_room_id: current_room_id, user_rooms: Rooms.get_user_rooms(current_user))}
  end
  ...
  def render(assigns) do
    ...
    <div class="bg-indigo-900 text-indigo-200 w-1/4 pb-6 md:block">
      ...
      <div class="mb-6 py-1 px-4 text-white font-semi-bold ">
